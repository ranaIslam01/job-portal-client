...
const SignIn = () => {
  ...
  const [loading, setLoading] = useState(false); // ডিফল্ট ভ্যালু false হবে
    ...
    <div className="min-h-[85vh] flex items-center justify-center bg-gray-50 px-4 py-12">
      ...
      <div className="max-w-md w-full bg-white p-8 rounded-3xl shadow-2xl shadow-gray-200/50 border border-gray-100">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight">স্বাগতম!</h2>
          <p className="text-gray-500 mt-2 font-medium">আপনার অ্যাকাউন্টে লগইন করুন</p>
        </div>

        <form onSubmit={handleSignIn} className="space-y-6">
          {/* Email Field */}
          <div className="group">
            <label className="block text-sm font-bold text-gray-700 mb-1.5 ml-1">ইমেইল</label>
          ...
          <div className="group">
            <div className="flex justify-between items-center mb-1.5 ml-1">
              ...
              <a href="#" className="text-xs font-bold text-blue-600 hover:text-blue-700 hover:underline">পাসওয়ার্ড ভুলে গেছেন?</a>
            </div>
            <div className="relative flex items-center">
              <span className="absolute left-4 text-gray-400 group-focus-within:text-blue-500 transition-colors">
          ...
          <div className="space-y-4">
            <button
              ...
              className={`w-full bg-blue-600 text-white py-4 rounded-2xl font-bold text-lg transition-all duration-300 transform active:scale-[0.98] flex justify-center items-center ${
                loading ? "opacity-70 cursor-not-allowed" : "hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-200"
              }`}
            >
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-500 font-medium">
            অ্যাকাউন্ট নেই? 
            <Link to="/signup" className="text-blue-600 font-extrabold ml-1 hover:text-blue-700 transition-colors">রেজিস্ট্রেশন করুন</Link>
          </p>
        </div>
      </div>
    </div>
